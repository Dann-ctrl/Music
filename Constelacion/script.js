/**
 * PERSONALIZA TU CONSTELACIÓN AQUÍ
 * Cambia únicamente estos valores para crear tu propia dedicatoria.
 */
const CONFIG = {
  recipientName: "Mi Princesa Hermosaaa",
  senderInitial: "G",
  recipientInitial: "J",
  invitation: "Tengo algo escrito en las estrellas para ti.",
  starMessages: [
    "Tu sonrisa ilumina mis días",
    "Contigo todo se siente especial",
    "Eres mi lugar favorito en el mundo",
    "Siempre te elegiría sin pensarlo",
    "Gracias por enseñarme lo que es amar"
  ],
  finalMessage: "Tu presencia hace que todo sea más bonito para mí. Cada momento contigo lo valoro muchísimo y me hace feliz tenerte en mi vida. Eres una persona muy especial para mí y espero que sigamos compartiendo muchos momentos juntos, porque lo que siento por ti es algo muy sincero.",
