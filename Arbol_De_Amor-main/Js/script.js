...
fetch('Img/treelove.svg')
  ...
  .then(svgText => {
    ...
    const heartPaths = allPaths.filter(el => {
      ...
      return style.includes('#B7A1FF') || style.includes('#BC68FC');
    });
...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para Mi Preciosa:\n\nAntes de conocerte nunca imagine que llegara a sentir o enamorarme de la manera que estoy, hasta que llegaste a mi vida.\n\nSin darme cuenta con el paso de todo los dias desde que nos hemos conocido, cada detalle, abrazo, palabra y forma en la que me has transmitido tu cariño hizo que te quedaras muy profundo en mi corazón.\n\nSe que no he sido el hombre que te mereces y que he cometido muchisimo errores, es algo que quiero cambiar para siempre verte sonreir y no volver a ver que derrames una lagrima por mi.\n\n Gracias por estar a mi lado en los días buenos y en los difíciles, por escucharme y siempre comprenderme.\n\nTe amo demasiado gisell, nunca olvides eso.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con mucho amor y cariño, Junior.";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-02-25T00:00:00'); 
